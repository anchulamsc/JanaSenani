...
public class RegistrationRestController {
	...
	@RequestMapping(value = "/listusers", method = RequestMethod.GET, headers = "Accept=application/json", produces = MediaType.APPLICATION_JSON_VALUE)
	public ResponseEntity<RegistrationInfoWrapper> listRegisteredUsers() {
