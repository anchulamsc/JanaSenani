package com.sena.dms.spring.validator;
...
@Component
public class DataDisplayValidator implements Validator {

	private static final Logger logger = LoggerFactory.getLogger(DataDisplayValidator.class);
