...
import com.sena.dms.spring.model.data.EmailProperties;
...
public class EmailSenderUtil {
	...
	public static void sendMessage(PersonalInfo contactInfo) {
	...
	public static void sendReplyConfirmation(PersonalInfo contactInfo) {
