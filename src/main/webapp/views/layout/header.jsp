...
<div>
	...
	<table width="100%" height="60" border="0" cellpadding="0"
		...
		<tbody>
			<tr>
				<td bgcolor="lightorange">
					<table width="1000" border="0" align="center" cellpadding="0" cellspacing="0">
						<tbody>
							<tr>
								<td width="200"><a href="<c:url value='/'/>"><img  title="Young Engineers" src="${pageContext.request.contextPath}/resources/images/YuvaSenaIcon.jpg" width="154" height="30" /></a></td>
								<td width="560">
								...
								<td width="220" align="right">
									<table border="0" cellspacing="0" cellpadding="0">
										<tbody>
											<tr>
												<td><span class="red"><a href="<c:url value='/registration/login'/>" title="Login"  class="font_style3 red">Login</a></span></td>
												<td width="20">&nbsp;</td>
												<td>
													<table border="0" cellspacing="0" cellpadding="0">
														<tbody>
															<tr>
																<td bgcolor="green">&nbsp;</td>
																<td bgcolor="green"><a  title="Sign Up"  href="<c:url value='/registration/register'/>"><span class="font_style2">Sign Up</span></a></td>
																<td bgcolor="green">&nbsp;</td>
															</tr>
														</tbody>
													</table>
